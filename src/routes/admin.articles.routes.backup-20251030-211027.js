...
// ✅ Models (used by some routes below)
const Article = require('../models/Article');

// ✅ Controller that runs auto image attach (you created this in Step 2.1)
const ctrl = require('../controllers/admin.articles.controller');

// ✅ If you have admin auth, uncomment and use it on POST/PATCH/Publish routes
...
// ────────────────────────────────────────────────────────────────────────────────
// router.post('/', requireAuthAdmin, ctrl.createOne);
...
// ────────────────────────────────────────────────────────────────────────────────
// router.post('/import', requireAuthAdmin, ctrl.importMany);
...
// ────────────────────────────────────────────────────────────────────────────────
router.post('/preview-import', ctrl.previewMany); // ← ADD THIS HERE
